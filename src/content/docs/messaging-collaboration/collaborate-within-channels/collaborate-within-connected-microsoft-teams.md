...
يتيح تكامل منصة تعاون مع **Microsoft Teams** كسر حواجز العزلة في بيئات العمل المختلطة، وذلك من خلال إعادة توجيه إشعارات الدردشة  في الوقت الفعلي من Teams إلى منصة تعاون.
...
2. في أي قناة، نفّذ أمر الشرطة المائلة  بكتابة `/msteams connect` وانقر على الرابط الناتج.
...
بعد ربط حسابك، وفي حال كنت غير متصل بالإنترنت  أو غير متواجد  على Microsoft Teams، فإن أي رسائل تتلقاها في محادثة فردية أو جماعية على Teams ستظهر كإشعار داخل منصة تعاون. سيتضمن الإشعار رابطًا لفتح المحادثة في Microsoft Teams لمواصلة النقاش. (لن تظهر هذه الإشعارات إذا كنت نشطًا مؤخرًا في Teams).

![مثال على إشعار رسالة دردشة.](../../../../images/microsoft-teams-chat-notifications.png)

### إدارة إعدادات الإشعارات

يمكنك إدارة إعدادات إشعارات تكامل Microsoft Teams في أي وقت بالانتقال إلى **الإعدادات**  > **تفضيلات الإضافات** .
...
:::note
يمكنك تشغيل [أوامر الشرطة المائلة ](/integrations-guide/run-slash-commands) التالية لإدارة إعدادات التكامل عن طريق كتابة الأمر في حقل كتابة الرسائل، ثم النقر على **إرسال** :
...
يتم إرسال إشعارات الدردشة في الوقت الفعلي عندما تكون غير نشط في Microsoft Teams وتتلقى رسالة فردية أو جماعية. تعتمد منصة تعاون على حالة اتصالك  في Teams لتحديد ما إذا كان ينبغي إرسال الإشعار أم لا. يتم إرسال الإشعارات إذا كانت حالتك في Microsoft Teams تظهر كـ **غائب**  أو **غير متصل** . وعليه، يعتمد السلوك الافتراضي لتوقيت تسليم الإشعارات على كيفية وصولك إلى Microsoft Teams:

* **متصفح الويب:** تقوم منصة تعاون بإرسال الإشعارات إذا لم تقم بأي نشاط في علامة تبويب Microsoft Teams لمدة 5 دقائق أو أكثر، أو عند إغلاق علامة التبويب، أو عندما تضبط حالتك يدويًا على **غير متصل** .
* **تطبيق سطح المكتب:** تقوم منصة تعاون بإرسال الإشعارات إذا لم تقم بأي نشاط على جهاز الكمبيوتر لمدة 5 دقائق أو أكثر، أو عند إغلاق تطبيق Microsoft Teams، أو عندما تضبط حالتك يدويًا على **غير متصل** .

لتجنب تكرار الإشعارات ، لن تقوم منصة تعاون بإرسال إشعارات الدردشة إذا كانت حالة التواجد الخاصة بك في Microsoft Teams مضبوطة على: **متاح** ، **مشغول** ، **الرجاء عدم الإزعاج** ، أو **سأعود حالاً** .
