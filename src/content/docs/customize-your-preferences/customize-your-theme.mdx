---
title: "تخصيص سمة منصة تعـــاون"
description: "تعرف على كيفية تخصيص واجهة مستخدم منصة تعـــاون باختيار سمات قياسية أو إنشاء سمات مخصصة عبر الويب وسطح المكتب والجوال."
---

import { Tabs, TabItem } from "@astrojs/starlight/components";
import FAIcon from "../../../components/FAIcon.astro";

ألوان واجهة مستخدم منصة تعـــاون قابلة للتخصيص. يمكنك الاختيار من بين خمس سمات قياسية مصممة بواسطة منصة تعـــاون، أو تصميم سمة مخصصة خاصة بك. يتم تطبيق تغييرات السمات الخاصة بك على جميع الفرق التي تنتمي إليها، وتكون مرئية عبر جميع عملاء منصة تعـــاون. يمكن لعملاء مستوى Enterprise تكوين سمة مختلفة لكل فريق هم أعضاء فيه.

<Tabs>
  <TabItem label="الويب وسطح المكتب">
    اختر أيقونة **الإعدادات** <FAIcon name="gear" /> ، ثم انتقل إلى **العرض > السمة**. اختر **ألوان السمة** للاختيار من بين خمس سمات قياسية مصممة بواسطة فريق منصة تعـــاون.

    يمكنك تخصيص السمة القياسية بشكل أكبر لجعلها خاصة بك حقاً. بعد تحديد سمة قياسية، اختر **سمة مخصصة** وقم بتعديل اختيارات الألوان بناءً على تفضيلاتك.
  ...
  <TabItem label="الهاتف المحمول">
    ...
    :::note
    يمكنك فقط تحديد **سمة مخصصة** عند استخدام منصة تعـــاون في متصفح الويب أو تطبيق سطح المكتب.
    :::
...
اختر **سمة مخصصة**، ثم قم بتوسيع خيارات **أنماط الشريط الجانبي** و **أنماط القناة المركزية** و **أنماط الروابط والأزرار** لتخصيص ألوان واجهة فردية، مثل الخلفيات والروابط والنصوص والحدود.

يتم تطبيق تغييرات السمات المخصصة الخاصة بك في منصة تعـــاون بمجرد إجرائها (معاينة حية). اختر **حفظ** لتأكيد تغييرات السمات الخاصة بك. يمكنك تجاهل تغييراتك بالخروج من نافذة **إعدادات العرض** واختيار **نعم، تجاهل**.

### تصدير واستيراد سماتك المخصصة

- **التصدير:** يمكنك تصدير سمة من منصة تعـــاون عن طريق نسخ قيم السمة من قائمة **سمة مخصصة**.
- **الاستيراد:** استورد سمة إلى منصة تعـــاون عن طريق لصق قيم السمة في حقل **نسخ ولصق لمشاركة ألوان السمة**، ثم اختر **حفظ**.
...
![منصة تعـــاون Dark Theme](../../../images/MattermostDark.png)
...
في نظامي Windows و macOS، يتم تطبيق تفضيل العرض (الوضع الفاتح أو الوضع الداكن) الذي قمت بتعيينه على جهاز الكمبيوتر الخاص بك تلقائياً على تطبيق منصة تعـــاون لسطح المكتب. في نظام Linux، يمكنك إدارة ذلك يدوياً عبر قائمة **View**.
