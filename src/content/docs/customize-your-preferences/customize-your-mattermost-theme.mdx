...
<Tabs>
  <TabItem label="الويب وسطح المكتب">
    اختر أيقونة **الإعدادات** <FAIcon name="gear" /> ، ثم انتقل إلى **العرض > السمة**. اختر **ألوان السمة** للاختيار من بين خمس سمات قياسية مصممة بواسطة فريق ماترموست.
  ...
  <TabItem label="الجوال">
    اضغط على **السمة** لاختيار واحدة من 5 سمات قياسية لماترموست.

    :::note
    يمكنك فقط تحديد **سمة مخصصة** عند استخدام ماترموست في متصفح الويب أو تطبيق سطح المكتب.
    :::
...
يتم تطبيق تغييرات السمات المخصصة الخاصة بك في ماترموست بمجرد إجرائها (معاينة حية). اختر **حفظ** لتأكيد تغييرات السمات الخاصة بك. يمكنك تجاهل تغييراتك بالخروج من نافذة **إعدادات العرض** واختيار **نعم، تجاهل**.

### تصدير واستيراد سماتك المخصصة

- **التصدير:** يمكنك تصدير سمة من ماترموست عن طريق نسخ قيم السمة من قائمة **سمة مخصصة**.
- **الاستيراد:** استورد سمة إلى ماترموست عن طريق لصق قيم السمة في حقل **نسخ ولصق لمشاركة ألوان السمة**، ثم اختر **حفظ**.
